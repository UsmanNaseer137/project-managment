...
## Product roadmap
The product roadmap provides a high level view of the expected product, it's requirements and an estimated timeline for reaching milestones. 

## Tips
1. You'll need to ensure that product release dates are only rough estimates. 

## Tips for creating a release plan
1. It's very important that the Product Owner and Project Manager or Scrum Master work together to develop each release plan.
2. This is because the release plans need to connect the product roadmap with the team's capacity and velocity.
3. Factor these into any release plans that might be affected.
4. Scrum Master or Project Manager should always review the release plan before starting a Sprint planning session.

## The capacity and velocity
1. The capacity and velocity is the measure of the team's ability to complete work at a certain pace.
2. Agile principles, which states Agile processes, promote sustainable development. The sponsors, developers, and users should be able to maintain a constant pace indefinitely. 
3. If there are any hard dates or deadlines on your roadmap, meaning a date that cannot change, factor these into any release plans that might be affected.

## Factors resulting in changes to the release plan
1. Team velocity changes
2. Change to product scope
3. Improving the understanding of how much effort is needed to build certain features. 
...
1.  based on shared workplace values 
2.  Demostrated via  people's behaviors, activities, the way they communicate, and how they work with each other.

## Change management
process of getting folks to adopt a new product, process, or in Agile's case, a new value system.

## Change takes patient persistence.

## Create a sense of ownership
1. find an executive sponsor who also feels a sense of ownership for the change you're creating.
2. Having buy-in from someone at the top increases your chances of successfully driving any change in organizational culture. 

## Creating a sense of urgency / Need
1. My favorite approach to this is to ask the team, the organization, and the stakeholders questions about what's working and what's not working right now.
2. Then I ensure the changes relate directly to those opportunities. Here are some questions you could try.
...
1. Personal motivation: Are the individuals motivated internally to engage in the new behavior? Can you help them “love what they hate”? Example: Ensure the Product Owner is timely, appreciative, and effective while giving their feedback. 
...
I'm going to break down your role as a coach into three steps, similar to how you might approach being a coach for a sports team. 
1. First, you'll design the "plays" with the team. 
2. Second, you'll provide feedback to the team. 
3. Lastly, you'll celebrate and learn with the team. 
...
1. One industry report showed that 85 percent of organizations have adopted a product-centric model, which is associated with an Agile approach.
2. Businesses face a lot of volatility, uncertainty, complexity, and ambiguity, and they recognize that Agile and the frameworks that derive from it are a way to overcome those challenges.
3. One emerging Agile framework is called DevOps, which combines software development and IT operations.

## DevOps
Our Google Cloud Platform Business defines DevOps as an organizational and cultural movement that aims to increase software delivery velocity, improve service reliability, and build shared ownership among software stakeholders. 

1. DevOps is about growing and managing teams and organizations that can build and evolve large-scale systems at a rapid pace.   
2. These systems need to be both secure and reliable, so they can better deliver value to customers and organizations.

 ## Business agility
 which involves incorporating Agile principles into the wide sphere of management, so that the organization can thrive in high VUCA environments.
 
 1.  As an Agile project manager in a larger organization, you might find yourself using frameworks like 
-- Scrum of Scrums
